      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <?php
            ...
            $query_barang = mysqli_query($con,"SELECT * FROM barang where kode_barang='$kode_barang'")or die(mysqli_error());
            $databar = mysqli_fetch_array($query_barang);
          ?>
            <!-- The Modal -->
            ...
            <div class="modal-dialog">
                ...
                <form action="updatebarang.php"class="form-barang" method="POST" id="form-barang">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="register" name="register" value="<?=$databar['register'];?>">
                    </div>
                    <div class="form-group">
                        <label for="merk">Merk:</label>
                        <input type="text" class="form-control" id="merk" name="merk" value="<?=$databar['merk'];?>">
                    </div>
                    <div class="form-group">
                        <label for="ukuran">Ukuran:</label>
                        <input type="text" class="form-control" id="ukuran" name="ukuran" value="<?=$databar['ukuran'];?>">
                    </div>
                    <div class="form-group">
                        <label for="bahan">Bahan:</label>
                        <input type="text" class="form-control" id="bahan" name="bahan" value="<?=$databar['bahan'];?>">
                    </div>
                    <div class="form-group">
                        <label for="tanggal_beli">Tanggal Beli:</label>
                        <input type="date" class="form-control" id="tanggal_beli" name="tanggal_beli" value="<?=$databar['tanggal_beli'] ;?>">
                    </div>
                    <div class="form-group">
                        <label for="no_pabrik">No Pabrik:</label>
                        <input type="text" class="form-control" id="no_pabrik" name="no_pabrik" value="<?=$databar['no_pabrik'];?>">
                    </div>
                    <div class="form-group">
                        <label for="sumber_perolehan">Sumber Perolehan:</label>
                        <input type="text" class="form-control" id="sumber_perolehan" name="sumber_perolehan" value="<?=$databar['sumber_perolehan'];?>">
                    </div>
                    <div class="form-group">
                        <label for="harga_perolehan">Harga Perolehan:</label>
                        <input type="text" class="form-control" id="harga_perolehan" name="harga_perolehan" value="<?=$databar['harga_perolehan'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ruang" name="ruang" value="<?=$databar['ruang'];?>">
                    </div>
                </div>
