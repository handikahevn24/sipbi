        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="table-responsive">
                    ...
                    if ($result = $con->query($sql)){
                        while($data = $result->fetch_assoc()){
                          ...
                          <tr>
                            ...
                            <td><?= $data['alamat'];?></td>
                            <td><?= $data['no_telp'];?></td>
                            <td><a href="editsupplier.php?kode_supplier=<?=$data['kode_supplier'];?>"><span data-feather="edit"></span></a> | <a href="hapussupplier.php?kode_supplier=<?=$data['kode_supplier'];?>"><span data-feather="trash"></span></a></td>
                          </tr>
                          <?php
                        }
                    }
            ...
            <div class="modal-dialog">
                ...
                <form action="tambahsupplier.php"class="form-supplier" method="POST" id="form-supplier">
